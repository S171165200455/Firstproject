...
<html lang="en">
  ...
  <link rel="icon" type="image/png"  href="<c:url value="/resources/img/logo1.png"/>" sizes="16x16">
    ...
    <!-- Theme color -->
    <link id="switcher"  rel="stylesheet" href="<c:url value="/resources/css/default-theme/green-theme.css"/>">
		 ...
		 <div class="aa-logo">
                ...
                <a href="indexpage">
                  <span class="glyphicon glyphicon-sunglasses"></span>
                   <p style="font-family:Comic Sans MS">LeoShop<strong>Glasses</strong> <span>Buy rigth glasses for you</span></p>
                </a> 
                <!-- img based logo -->
